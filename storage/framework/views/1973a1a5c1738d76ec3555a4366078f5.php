...
<script>
const chatUsers = <?php echo json_encode($chatUsers->map(fn($u) => ['id' => $u->id, 'name' => $u->name, 'avatar_url' => $u->avatar_url])) ?>;
const currentUserId = <?php echo e($currentUserId); ?>;
...
<?php /**PATH /home/sentrasi/public_html/resources/views/components/floating-chat.blade.php ENDPATH**/ ?>