...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-brand">
            ...
            <h1 class="brand-title"><?php echo e($appName); ?></h1>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div style="color: #dc2626; font-size: 0.85rem; margin-top: 6px;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-footer">
                <?php echo e($appName); ?> © <?php echo e(date('Y')); ?> - All rights reserved
            </div>
        </div>
    </div>
    ...
    <?php if(session('swal')): ?>
        <script>
            Swal.fire({
                ...
                confirmButtonColor: '<?php echo e($colors["primary"]); ?>'
            });
        </script>
    <?php endif; ?>
</body>
</html>
<?php /**PATH /home/sentrasi/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>