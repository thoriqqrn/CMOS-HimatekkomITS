<?php $__env->startSection('title', 'Tambah Timeline'); ?>
<?php $__env->startSection('page-title', 'Tambah Timeline'); ?>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select id="type" name="type" class="form-control form-select <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="global" <?php echo e(old('type') === 'global' ? 'selected' : ''); ?>>Global</option>
                                    <option value="department" <?php echo e(old('type') === 'department' ? 'selected' : ''); ?>>Department</option>
                                    <option value="program" <?php echo e(old('type') === 'program' ? 'selected' : ''); ?>>Program</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="color" id="color" name="color" class="form-control" value="<?php echo e(old('color', '#7C3AED')); ?>" style="height: 42px;">
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group" id="programField" style="display: none;">
                        ...
                        <select id="program_id" name="program_id" class="form-control form-select <?php $__errorArgs = ['program_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sentrasi/public_html/resources/views/timelines/create.blade.php ENDPATH**/ ?>