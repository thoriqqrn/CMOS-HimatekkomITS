...
<?php $__env->startSection('page-title', 'Kalender Timeline'); ?>
...
<div class="card animate-fadeIn">
    <div class="card-header">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('timelines.index')); ?>" class="btn btn-secondary btn-sm">
                <i class="fas fa-list"></i> List View
            </a>
            <?php if(auth()->user()->hasRole(['admin', 'bph', 'kabinet'])): ?>
            <a href="<?php echo e(route('timelines.create')); ?>" class="btn btn-primary btn-sm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: '<?php echo e(route("timelines.calendar.data")); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sentrasi/public_html/resources/views/timelines/calendar.blade.php ENDPATH**/ ?>