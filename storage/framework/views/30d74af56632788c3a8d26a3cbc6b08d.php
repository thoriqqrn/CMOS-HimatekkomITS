...
<body>
    <nav class="navbar">
        ...
        <div class="actions">
            <a href="<?php echo e(route('home')); ?>" class="btn"><i class="fas fa-arrow-left"></i> Landing</a>
            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary"><i class="fas fa-right-to-bracket"></i> Login</a>
        </div>
    </nav>
    ...
    <main class="container">
        <form method="GET" action="<?php echo e(route('informasi.index')); ?>" class="filters">
            <input type="text" name="q" value="<?php echo e($search); ?>" placeholder="Cari artikel...">
            <select name="kategori">
                <option value="">Semua Kategori</option>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($category->slug); ?>" <?php if($activeCategory?->id === $category->id): echo 'selected'; endif; ?>><?php echo e($category->name); ?></option>
        ...
        <div class="grid">
            ...
            <article class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="excerpt"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($article->excerpt ?: $article->content), 145)); ?></p>
                    <a href="<?php echo e(route('informasi.show', $article->slug)); ?>" class="read-btn"><i class="fas fa-book-open"></i> Baca Detail</a>
                </div>
            </article>
...
<?php /**PATH /home/sentrasi/public_html/resources/views/informasi/index.blade.php ENDPATH**/ ?>