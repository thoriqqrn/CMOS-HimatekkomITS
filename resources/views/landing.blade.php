...
<body>
    ...
    <section class="experience" id="experience" style="background: #0A0A14; padding: 6rem 2rem;">
        ...
        <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.5rem;">
            ...
            <article style="background: linear-gradient(145deg, rgba(74, 20, 140, 0.2) 0%, rgba(255, 215, 0, 0.05) 100%); border: 1px solid rgba(255, 215, 0, 0.2); border-radius: 24px; overflow: hidden;">
                ...
                <img src="{{ $article->cover_image_url }}" alt="{{ $article->title }}" style="width: 100%; height: 190px; object-fit: cover;">
                @endif
                <div style="padding: 1.5rem;">
                    ...
                    <h4 style="color: var(--gold); font-size: 1.1rem; font-weight: 700; margin-bottom: 0.75rem;">{{ $article->title }}</h4>
                    <p style="color: rgba(255,255,255,0.8); line-height: 1.7; margin-bottom: 1rem;">{{ \Illuminate\Support\Str::limit(strip_tags($article->excerpt ?: $article->content), 130) }}</p>
                    <a href="{{ route('informasi.show', $article->slug) }}" class="btn-outline" style="font-size: 0.9rem; padding: 10px 18px;">
        ...
        <div style="text-align: center; margin-top: 2rem;">
            <a href="{{ route('informasi.index') }}" class="btn-primary">
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} HIMATEKKOM ITS 2026 - Kabinet Sentra Sinergi. Semua hak dilindungi.</p>
        </div>
    </footer>
